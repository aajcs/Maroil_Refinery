    ...
    <div className="card h-full">
      ...
      {selectedBalance && analisisData && !loading && (
        <div className="mt-4 grid">
                ...
                >
                  ...
                  <Column
                    ...
                    body={(rowData) => {
                      ...
                      return totalVenta > 0 ? formatCurrency(totalVenta) : "-";
                    }}
                    style={{ width: "15%" }}
                  ></Column>
                  <Column
                  ...
                  <Column
                    header="Rendimiento (%)"
                    body={(rowData) =>
                      selectedBalance && selectedBalance.totalBarrilesCompra > 0
                        ? `${(
          ...
          <Card title="Detalle de Contratos de Compra" className="mt-4 col-6">
            <Accordion>
          ...
          <Card title="Detalle de Contratos de Venta" className="mt-4 col-6">
            <Accordion>
