...
const ChequeoCalidadTemplate: React.FC<{ data: ChequeoCalidad }> = ({
  data,
}) => {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.companyInfo}>
            <Text style={styles.header}>Reporte de Chequeo de Calidad</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Información de Calidades</Text>
